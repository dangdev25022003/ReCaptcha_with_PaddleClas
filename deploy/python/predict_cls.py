...
class ClsPredictor(Predictor):
    def __init__(self, config):
        ...
        global_config = config.get("Global", None)
        if global_config is None:
            raise ValueError("Missing 'Global' configuration section.")
...
if __name__ == "__main__":
    ...
    print("Path to YAML config:", args.config)  # Debug xem đường dẫn có đúng không
    print("Does config exist?", os.path.exists(args.config))  # Kiểm tra file có tồn tại không
